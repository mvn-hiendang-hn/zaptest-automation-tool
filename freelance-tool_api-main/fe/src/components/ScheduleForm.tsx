...
const ScheduleForm: React.FC<ScheduleFormProps> = ({
  ...
  const [collectionId, setCollectionId] = useState(
    schedule?.collectionId || collections[0]?.id || ""
  );
  ...
  const [dayTime, setDayTime] = useState<string>(schedule?.dayTime || "09:00");
  ...
  const validateName = async (scheduleName: string) => {
    ...
    try {
      ...
      if (!isUnique) {
        setNameError(
          `A schedule with the name "${scheduleName}" already exists`
        );
        return false;
      }
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={timerType}
              onValueChange={(value: "minute" | "hour" | "day" | "week") =>
                setTimerType(value)
              }
            >
              <SelectTrigger>
          ...
          {timerType === "minute" && (
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setMinuteInterval(parseInt(value) as 5 | 15 | 30)
                }
              >
                <SelectTrigger>
          ...
          {timerType === "hour" && (
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setHourInterval(parseInt(value) as 1 | 2 | 4 | 6 | 12)
                }
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select interval" />
